...
<div class="loginBox">
	<div class="loginMain">
		<div class="tabwrap">
		<form action="doctoruser" method="post" >
		<table border="0" cellspacing="0" cellpadding="0">
			...
			<tr><td>&nbsp;</td><td><input type="submit" class="loginbtn" value="登录" onclick="location.href='index.html'"/><input type="button" class="resetbtn" value="重置" onclick="location.href=''"/></td></tr>		
