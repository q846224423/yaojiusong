...
<div class="login">
  <h1>医生注册</h1>
  <form action="doctorzucwc" method="post">
    ...
    <input type="password" name="password" placeholder="科室" required="required">
    <input type="password" name="password" placeholder="科别" required="required">   
