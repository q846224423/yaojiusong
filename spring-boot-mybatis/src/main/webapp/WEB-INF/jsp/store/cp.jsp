...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    function check(){
    	...
    	if(a==b&&a!=""&&b!=""){
    		window.location.href="QTXiuGaiMiMaCp?uname="+name+"&pwd="+a;
    	}else{
    		$("#sss").html("*密码不一致").css("color","red");
    	}
    }
		...
		<div class="reg_c">
            ...
            <table border="0" style="width:420px; font-size:14px; margin-top:20px;" cellspacing="0" cellpadding="0">
              ...
              <tr height="50">
                ...
                <td><input type="text" value="<%=name%>" id="name1" class="l_user" /></td>
              </tr>
             <tr>
             </tr>
              <tr height="50">
                <td align="right"><font color="#ff4e00">*</font>&nbsp;新密码 &nbsp;</td>
                <td><input type="password" class="l_pwd" id ="id1"/></td>
              </tr>
              <tr height="50">
                <td align="right"><font color="#ff4e00">*</font>&nbsp;确认新密码 &nbsp;</td>
                <td><input type="password"  class="l_pwd" id="id2" /></td>
              </tr>
             <tr>
              	<td ></td>
                <td id="sss"></td>
              ...
              <tr height="80">
              	<td>&nbsp;</td>
                <td><input type="text" value="立即修改" class="log_btn" onclick="check()" /></td>
              </tr>
            </table>
            </form>
        </div>
