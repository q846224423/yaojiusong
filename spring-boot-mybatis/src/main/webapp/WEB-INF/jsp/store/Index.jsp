...
<%@page import="com.shop.service.ShowMenuService"%>
<%@page import="com.shop.entity.News"%>
<%@page import="java.util.List"%>
<%@page import="com.shop.daoimpl.ct_Newsimpl"%>
...
ShowMenuService ms = new ShowMenuService();
List<Menu1> list = ms.getMenu();
...
<div class="i_bg bg_color">
	<div class="i_ban_bg">
        ...
        <div class="inews">
            ...
            <c:when test="${userid==null }">
            <div class="news_t">
   			<span class="fr"><a href="Jump3.jsp">更多 ></a></span>新闻资讯
            </div>
             <ul>
            <%
            
            int a = 1;
            ct_Newsimpl ct=new ct_Newsimpl();
            List<News> ctlist=ct.selectfy(a);
            
            for(News n : ctlist){%>
            	<li><span>[ 公告 ]</span><a href="Jump3.jsp"><%=n.getTitle()%></a></li>
<%}%>
            </ul>
            </c:when>
            ...
            <c:otherwise>
            <div class="news_t">
   <span class="fr"><a href="chen_newsgd">更多 ></a></span>新闻资讯
            </div>
             <ul>
            <%
            ...
            for(News n : ctlist){%>
            	<li><span>[ 公告 ]</span><a href="index_newsx?id=<%=n.getId()%>"><%=n.getTitle()%></a></li>
<%}%>
            </ul>
            </c:otherwise>
    ...
    <div class="b_nav">
        ...
        <dl>
        	<dt><a href="http://www.whqsjy.cn">联系我们</a></dt>
            <dd><a href="#">网站故障报告</a></dd>
            <dd><a href="#">购物咨询</a></dd>
            <dd><a href="#">投诉与建议</a></dd>
            <dd><a href="http://m.whqsjy.cn">合作单位</a></dd>
