...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
 ...
 var id =<%=request.getAttribute("sid")%>;
 //alert(num+","+id);
 jQuery.ajax({
		url:"WY_shopCartInsertServlet",
		type:"post",
		data:{"menu3_id":id,"trade_num":num},
		dataType:"json",
		success:function(data){
			var SumPrice = data.sumprice;
			var UserId = data.userid;
			//jQuery("#show_id").text("用户id："+UserId+"总价："+SumPrice);
...
<div class="soubg">
	<div class="sou">
        ...
        <span class="fr">
        	...
        	<span class="fl">${nameshouye1==null?"你好":"欢迎你,"}<a href="Login.jsp">${nameshouye1==null?",请登录":nameshouye1}</a>&nbsp; <a href="Regist.jsp" style="color:#ff4e00;">免费注册</a>&nbsp;|&nbsp;
        	<c:choose>
        	
        	<c:when test="${userid == null }">
        	<a href="Login.jsp">我的订单</a>&nbsp;|</span>
        	</c:when>
        	
        	<c:otherwise>
        	<a href="WY_order1SelectAllServlet?userid=${userid }">我的订单</a>&nbsp;|</span>
        	</c:otherwise>
...
<div class="top">
    <div class="logo"><a href="Index.jsp"><img src="images/index/logo.png" /></a></div>
    <div class="search">
...
<div class="menu_bg">
	<div class="menu">
                 ...
                 <c:forEach items="${list1 }" var="menu1">
                    <li>
                    	...
                    	<span class="n_img"><span></span><img src="images/index/nav1.png" /></span>
                            <span class="fl">${menu1.menu1name }</span>
        ...
        <!--End 商品分类详情 End-->                                                     
    	<ul class="menu_r">                                                                                                                                               
        	<li><a href="ShowMenu">首页</a></li>
            <li><a href="QueryByidServlet?id=1">美食</a></li>
            <li><a href="QueryByidServlet?id=2">生鲜</a></li>
            <li><a href="QueryByidServlet?id=3">家居</a></li>
            <li><a href="QueryByidServlet?id=4">女装</a></li>
            <li><a href="QueryByidServlet?id=5">美妆</a></li>
            <li><a href="QueryByidServlet?id=6">数码</a></li>
            <li><a href="QueryAllServlet">所有商品</a></li>
        </ul>
...
<div class="i_bg">
    ...
    <div class="content">               
        <div id="tsShopContainer">
            <div id="tsImgS"><a href="${menu3.ep_url}" title="images/index" class="MagicZoom" id="MagicZoom"><img src="${menu3.ep_url}" width="390" height="390" /></a></div>
            ...
            <div class="des_choice">
                ...
                <ul>
                   <!--  <li class="checked">白色<div class="ch_img"></div></li> -->
                    <li>${menu3.ep_size }<div class="ch_img"></div></li>
                </ul>
            </div>
            <div class="des_share">
            	<div class="d_sh">
    ...
    <div class="content mar_20">
    	<div class="l_history">
        	...
        	<ul>
            	<li>
                    <div class="img"><a href="#"><img src="images/index/his_1.jpg" width="185" height="162" /></a></div>
                ...
                <li>
                    <div class="img"><a href="#"><img src="images/index/his_2.jpg" width="185" height="162" /></a></div>
                	<div class="name"><a href="#">Dior/迪奥香水2件套装</a></div>
                    <div class="price">
                ...
                <li>
                    <div class="img"><a href="#"><img src="images/index/his_3.jpg" width="185" height="162" /></a></div>
                	<div class="name"><a href="#">Dior/迪奥香水2件套装</a></div>
                    <div class="price">
                ...
                <li>
                    <div class="img"><a href="#"><img src="images/index/his_4.jpg" width="185" height="162" /></a></div>
                	<div class="name"><a href="#">Dior/迪奥香水2件套装</a></div>
                    <div class="price">
                    	<font>￥<span>368.00</span></font> &nbsp; 18R
                    </div>
                ...
                <li>
                    <div class="img"><a href="#"><img src="images/index/his_5.jpg" width="185" height="162" /></a></div>
                	<div class="name"><a href="#">Dior/迪奥香水2件套装</a></div>
                    <div class="price">
                    	<font>￥<span>368.00</span></font> &nbsp; 18R
                    </div>
        ...
        <div class="l_list">        	
            <div class="des_border">
                ...
                <div class="team_list">
                	<div class="img"><a href="#"><img src="images/index/mat_1.jpg" width="160" height="140" /></a></div>
                ...
                <div class="team_icon"><img src="images/index/jia_b.gif" /></div>
                <div class="team_list">
                	<div class="img"><a href="#"><img src="images/index/mat_2.jpg" width="160" height="140" /></a></div>
                ...
                <div class="team_icon"><img src="images/index/jia_b.gif" /></div>
                <div class="team_list">
                	<div class="img"><a href="#"><img src="images/index/mat_3.jpg" width="160" height="140" /></a></div>
                	<div class="name"><a href="#">香奈儿邂逅清新淡香水50ml</a></div>
                    <div class="price">
                    	<div class="checkbox"><input type="checkbox" name="zuhe" checked="checked" /></div>
                    	<font>￥<span>749.00</span></font> &nbsp; 18R
                ...
                <div class="team_icon"><img src="images/index/equl.gif" /></div>
                <div class="team_sum">
                	套餐价：￥<span>1517</span><br />
                    <input type="text" value="1" class="sum_ipt" /><br />
                    <a href="#"><img src="images/index/z_buy.gif" /></a> 
                </div>
            ...
            <div class="des_border" id="p_details">
                ...
                <div class="des_con">
                	<table border="0" align="center" style="width:745px; font-size:14px; font-family:'宋体';" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="265"><img src="images/index/de1.jpg" width="206" height="412" /></td>
                        <td>
                        	<b>迪奥真我香水(Q版)</b><br />
                            【商品规格】：5ml<br />
                            【商品质地】：液体<br />
                    ...
                    <p align="center">
                    <img src="images/index/de2.jpg" width="746" height="425" /><br /><br />
                    <img src="images/index/de3.jpg" width="750" height="417" /><br /><br />
                    <img src="images/index/de4.jpg" width="750" height="409" /><br /><br />
                    <img src="images/index/de5.jpg" width="750" height="409" />
					</p>
            ...
            <div class="des_border" id="p_comment">
                ...
                <table border="0" class="jud_tab" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="300">
                    	<table border="0" style="width:100%;" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <td><img src="images/index/pl.gif" align="absmiddle" /></td>
                          </tr>
                          <tr>
                    ...
                    <td class="jud_bg">您可对已购买商品进行评价<br /><a href="#"><img src="images/index/btn_jud.gif" /></a></td>
                  </tr>
                </table>
                ...
                <table border="0" class="jud_list" style="width:100%; margin-top:30px;" cellspacing="0" cellpadding="0">
                  <tr valign="top">
                    <td width="160"><img src="images/index/peo1.jpg" width="20" height="20" align="absmiddle" />&nbsp;向死而生</td>
                    <td width="180">
                  ...
                  <tr valign="top">
                    <td width="160"><img src="images/index/peo2.jpg" width="20" height="20" align="absmiddle" />&nbsp;就是这么想的</td>
                    <td width="180">
                    	颜色分类：<font color="#999999">粉色</font> <br />
                        型号：<font color="#999999">50ml</font>
                    </td>
                  ...
                  <tr valign="top">
                    <td width="160"><img src="images/index/peo3.jpg" width="20" height="20" align="absmiddle" />&nbsp;墨镜墨镜</td>
                    <td width="180">
                    	颜色分类：<font color="#999999">粉色</font> <br />
                        型号：<font color="#999999">50ml</font>
                    </td>
                  ...
                  <tr valign="top">
                    <td width="160"><img src="images/index/peo4.jpg" width="20" height="20" align="absmiddle" />&nbsp;那*****洋 <br /><font color="#999999">（匿名用户）</font></td>
                    <td width="180">
                    	颜色分类：<font color="#999999">粉色</font> <br />
                        型号：<font color="#999999">50ml</font>
                    </td>
        ...
        <div class="white_d">
            ...
            <div class="notice_c">
                ...
                <table border="0" align="center" style="margin-top:;" cellspacing="0" cellpadding="0">
                  ...
                  <tr height="50" valign="bottom">
                  	<td>&nbsp;</td>
                    <td><a href="WY_ShopCartOneServlet" class="b_sure">去购物车结算</a><a href="ShowMenu" class="b_buy">继续购物</a></td>
                  </tr>
                </table>
