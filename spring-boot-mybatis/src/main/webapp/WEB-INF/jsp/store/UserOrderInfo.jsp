...
<div class="i_bg bg_color">
	...
	<c:forEach items = "${list }" var ="od2">
	
	<tr>
		<td><c:out value="${od2.order_shopname }"></c:out></td>
		<td><c:out value="${od2.order_price }"></c:out></td>
		<td><c:out value="${od2.order_num }"></c:out></td>
		<td><c:out value="${od2.order_allprice }"></c:out></td>
	</tr>
