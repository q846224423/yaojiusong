...
<div class="i_bg bg_color">
	...
	<div class="m_content">
   		<div class="m_left">
            ...
            <div class="left_m">
                ...
                <ul>
                	<li><a href="WY_order1SelectAllServlet?userid=${userid}" class="now">我的订单</a></li>
	...
	<c:forEach items = "${xlist }" var ="od2">
	
	<tr>
		<td><a href="Showinfo?id=${od2.menu3_id }"> <c:out value="${od2.menu3_name }"></c:out></a></td>
		<td><c:out value="${od2.menu3_price }"></c:out></td>
		<td><c:out value="${od2.trade_num }"></c:out></td>
		<td><c:out value="${od2.sum_price }"></c:out></td>
	</tr>
...
<span><a href="WY_order2SelectAllServlet?NowPage=1&userid=${userid }">首页</a>&nbsp;&nbsp;</span>
<span><a href="WY_order2SelectAllServlet?NowPage=${NowPage==1?1:NowPage-1}&userid=${userid }">上一页</a>&nbsp;&nbsp;</span>
<span><a href="WY_order2SelectAllServlet?NowPage=${NowPage==MaxNum?MaxNum:NowPage+1}&userid=${userid }">下一页</a>&nbsp;&nbsp;</span>
<span><a href="WY_order2SelectAllServlet?NowPage=${MaxNum}&userid=${userid }">尾页</a>&nbsp;&nbsp;</span>
