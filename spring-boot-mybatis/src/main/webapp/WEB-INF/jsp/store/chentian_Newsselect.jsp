	...
	<div class="m_content">
   		<div class="m_left">
            ...
            <div class="left_m">
                ...
                <ul>
                    <li><a href="chen_newsgd" class="now">新闻资讯</a></li>
                </ul>
            </div>
        </div>
		<div class="m_right">
...
%>
	...
	<c:forEach items="${map.list}" var="l" >
		<tr>
			<td>${l.title}</td>
			<td><a href="xbServlet">${l.sj }</a></td>
</tr>
</c:forEach>
</table>
		<a href="chen_newsgd?page=1">首页</a>
		<a href="chen_newsgd?page=<%=a-1%>">上一页</a>
		<%for(int i=1;i<=b;i++){%>
		<a href="chen_newsgd?page=<%=i%>"><%=i%></a> 
		<%}%>
		<a href="chen_newsgd?page=<%=a+1%>">下一页</a>
		<a href="chen_newsgd?page=<%=b%>">尾页</a> --%>
...
<table border="1" cellspacing="0px" >
	  	...
	  	<% Map map =(Map) request.getAttribute("map");
           ...
           <center> <div>
            <p style="border:1px solid darkgray; height: 30px; width: 50px; line-height: 30px; font-size: 20px;display:inline-block; "><a href="chen_newsgd?page=1">首页</a></p>
              <p style="border:1px solid darkgray; height: 30px; width: 100px;  line-height: 30px; font-size: 20px;display:inline-block "><a href="chen_newsgd?page=<%=a-1%>">上一页</a></p>
		...
		<%}%></p>
              ...
              <p style="border:1px solid darkgray; height: 30px; width: 60px; line-height: 30px; font-size: 20px;display:inline-block "><a href="chen_newsgd?page=<%=a+1%>">下一页</a></p>
              <p style="border:1px solid darkgray; height: 30px; width: 50px;  line-height: 30px; font-size: 20px;display:inline-block"><a href="chen_newsgd?page=<%=b%>">尾页</a></p>         
</div></center>
</div>
      <!--      更多 -->
