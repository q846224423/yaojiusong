	...
	<div class="m_content">
       ...
       <c:out value=" "></c:out>
    	 ...
    	 <c:forEach items = "${list }" var ="od">
			...
			<tr>
				<td><a href="WY_OrderInfoServlet?no=${od.order1_no }&userid=${userid}"><font color="#ff4e00">${od.order1_no }</font></a></td>
				...
				<td><a href="WY_UserConfirmServlet?status=${od.order1_status }&id=${od.order1_id }&userid=${od.useraccountid}"><c:out value="确认收货"></c:out></a></td>
				<td><a href="WY_UserRebateServlet?status=${od.order1_status }&id=${od.order1_id}&userid=${od.useraccountid}"><c:out value="申请退款"></c:out></a></td>
			</tr>
