...
<div class="top">
     <div class="logo"><a href="ShowMenu"><img src="images/logo.png" /></a></div>
    <div class="search">
    	<form action="QueryByName" method="post">
        	<input type="text" value="" class="s_ipt" name="ybquery" />
...
<div class="menu_bg">
	<div class="menu">
    	...
    	<ul class="menu_r">                                                                                                                                               
            ...
            <li><a href="QueryAllServlet">全部商品</a></li>
        </ul>
...
<div class="i_bg">
    ...
    <div class="content mar_20">
        ...
        <div class="l_list">
			<div class="brand_t">商品详情</div>
            <div class="list_c">
<!-- 这里插入商品列表 -->
               
<div class="id">
<c:forEach items="${infolist }" var="menu3">
<!-- 每张图片的盒子，与图片个数相关 -->
