...
<div class="i_bg bg_color">
	...
	<div class="m_content">
		...
		<div class="m_right"><span class="ct1"  style="font-size: 24px"><%List<News> List=(List<News>)request.getAttribute("list");
		for(News n:List){%>		
			<center><span style="color: red; font-size:35px" ><div id="blink">
	<strong>
...
</strong><%out.print(n.getTitle());%><br></span></center>
			<div style="text-indent: 2em"><%out.print(n.getContent());}%></div></span></div>
