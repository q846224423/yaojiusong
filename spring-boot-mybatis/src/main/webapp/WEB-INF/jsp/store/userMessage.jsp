...
<div class="i_bg bg_color">
	...
	<div class="m_content">
		...
		<div class="m_right">
            ...
            <div>&nbsp;</div>
               		<div style="font-size: 30px; margin-left: 48px;">欢迎你，${name}</div>
               		<div>&nbsp;</div>
               		<hr></hr>
            ...
            <table border="0" class="mon_tab" style="width:870px; margin-bottom:20px;" cellspacing="0" cellpadding="0">
              <tr>
                <td width="40%">用户ID：<span style="color:#555555;">${list[0].useraccountid}</span></td>
                </tr>
                <tr>
                <td width="60%">用户名：<span style="color:#555555;">${list[0].useraccountname}</span></td>
              </tr>
              <tr>
                <td>密&nbsp; &nbsp; 码：<span style="color:#555555;">${list[0].useraccountpassword}</span>&nbsp;&nbsp;&nbsp;&nbsp;<a href="cp.jsp?name=${list[0].useraccountname}">修改</a></td>
                 </tr>
                 <tr>
                <td>邮&nbsp; &nbsp; 箱：<span style="color:#555555;">${list[0].useraccountemail}</span></td>
              </tr>
              <tr>
                <td>电&nbsp; &nbsp; 话：<span style="color:#555555;">${list[0].useraccounttel}</span></td>
                 </tr>
                 <tr>
                <td>邀请人名：<span style="color:#555555;">${list[0].inviteaccountname}</span></td>
              </tr>
            </table>
