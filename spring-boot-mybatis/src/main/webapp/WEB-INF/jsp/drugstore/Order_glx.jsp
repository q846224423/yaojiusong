			...
			<div class="cgsuperCtab">
				<div class="Mian-cont-wrap">
					<div class="defaultTab-T">
						...
						<tbody><tr><th class="td_6">商品名称</th><th class="td_7">单价</th><th class="td_12">数量</th><th class="td_12">商品总价</th><th class="td_10"></th></tr>
						</tbody></table>
					</div>
					<table border="0" cellspacing="0" cellpadding="0" class="defaultTable defaultTable2">
						<tbody>
						<c:forEach items="${ydOrderx}" var="xd">
						<tr>
							<td class="td_6">${xd.menu3_name }</td>
							<td class="td_7">${xd.menu3_price }</a></td>
							<td class="td_12">${xd.trade_num }</td>
							<td class="td_12">${xd.sum_price }</a></td> 	
							<td class="td_10"><div class="btn"><a href="Showinfo?id=${xd.menu3_id }" style="background: #ff980b; color: #fff;">商品详情</a></div></td>
						</tr>
							</c:forEach>
