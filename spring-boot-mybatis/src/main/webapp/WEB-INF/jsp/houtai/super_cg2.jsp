	...
	<div class="super-content RightMain" id="RightMain">
		...
		<div class="superCtab">
			<div class="cg-title clearfix">
				<a href="javascript:;" class="default-add-btn newPdBtn"><i class="ico-add"></i>添加门店</a>
				<div class="searchBar">
				...
				<div class="Mian-cont-wrap">
					<div class="defaultTab-T">
						<table border="0" cellspacing="0" cellpadding="0" class="defaultTable">
							<tbody><tr><th class="td_6">药店名称</th><th class="td_7">所在地区</th><th class="td_8">评论</th><th class="td_8">药店登记信息</th><th class="td_11">认证状态</th><th class="td_10">操作</th></tr>
						</tbody></table>
					</div>
					<table border="0" cellspacing="0" cellpadding="0" class="defaultTable defaultTable2">
						<tbody><tr>
							<td class="td_6">同仁堂</td>
							<td class="td_7"><a href="#">武汉洪山</a></td>
							<td class="td_8"><a href="#" class="txdoc">老药店非常棒....</a></td>
