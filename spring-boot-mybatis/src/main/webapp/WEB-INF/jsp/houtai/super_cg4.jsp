	...
	<div class="super-content RightMain" id="RightMain">
		...
		<div class="superCtab">
			<div class="cg-title clearfix">
				<a href="javascript:;" class="default-add-btn newPdBtn"><i class="ico-add"></i>新建科室</a>
				<div class="searchBar">
				...
				<div class="Mian-cont-wrap">
					<div class="defaultTab-T">
						<table border="0" cellspacing="0" cellpadding="0" class="defaultTable">
							<tbody>
								<tr><th style="width: 40%; text-align: center;">科室号</th><th class="td_7" style="width:40%; text-align: center;">科室名称</th><th class="td_10">操作</th></tr>
							</tbody>
						</table>
					</div>
